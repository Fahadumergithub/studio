...
const locateFindingsPrompt = ai.definePrompt({
  ...
  prompt: `You are a specialist AI assistant for dental radiographs. You will be provided with a dental radiograph image and a JSON object containing a list of dental findings, including the disease and the tooth numbers affected.
...
The findings are: {{{JSON.stringify findings}}}
